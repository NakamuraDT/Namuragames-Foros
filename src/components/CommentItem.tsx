...
const createReply = async (
    ...
    if (!userId || !author) {
            throw new Error("Necesitas estar verificado para responder.");
        }
    ...
    <div className="pl-4 border-l border-white/10">
      <div className="mb-2">
        <div className="flex items-center space-x-2">
          {/* Mostrar el usuario de quien hace el comentario */}
      ...
      {comment.children && comment.children.length > 0 && (
        <div>
          <button
            ...
            title={isCollapsed ? "Esconder respuestás" : "Mostrar respuesta"}
          >
            {isCollapsed ? (
              <svg
